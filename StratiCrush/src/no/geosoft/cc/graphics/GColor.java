 /*
  * This is an independant copy of awt.Color.
  * 
...
import no.geosoft.graphics.factory.GFactory;
   ...
   * @see         AlphaComposite
   */
  public class GColor implements  java.io.Serializable, IColorImpl  {
       ...
       * @since 1.4
       */
      public final static GColor WHITE = white;
  
      /**
       * The color light gray.  In the default sRGB space.
       */
      public final static GColor lightGray = new GColor(192, 192, 192);
  
      /**
       * The color light gray.  In the default sRGB space.
       * @since 1.4
       */
      public final static GColor LIGHT_GRAY = lightGray;
       ...
       * @since 1.4
       */
      public final static GColor GRAY = gray;
  
      /**
       * The color dark gray.  In the default sRGB space.
       */
      public final static GColor darkGray  = new GColor(64, 64, 64);
  
      /**
       * The color dark gray.  In the default sRGB space.
       * @since 1.4
       */
      public final static GColor DARK_GRAY = darkGray;
       ...
       * @since 1.4
       */
      public final static GColor BLACK = black;
       ...
       * @since 1.4
       */
      public final static GColor RED = red;
       ...
       * @since 1.4
       */
      public final static GColor PINK = pink;
       ...
       * @since 1.4
       */
      public final static GColor ORANGE = orange;
       ...
       * @since 1.4
       */
      public final static GColor YELLOW = yellow;
       ...
       * @since 1.4
       */
      public final static GColor GREEN = green;
       ...
       * @since 1.4
       */
      public final static GColor MAGENTA = magenta;
       ...
       * @since 1.4
       */
      public final static GColor CYAN = cyan;
       ...
       * @since 1.4
       */
      public final static GColor BLUE = blue;
       ...
       * @see #getRGB
       */
      public GColor(int rgba, boolean hasalpha) {
          if (hasalpha) {
              value = rgba;
          } else {
      ...
      public GColor(float r, float g, float b, float a) {
        ...
        /**
         ...
         public GColor brighter() {
             ...
             return new GColor(Math.min((int)(r/FACTOR), 255),
        ...
        public GColor darker() {
            return new GColor(Math.max((int)(getRed()  *FACTOR), 0),
        ...
        public boolean equals(Object obj) {
            return obj instanceof GColor && ((GColor)obj).getRGB() == this.getRGB();
        }
         ...
         * @since      JDK1.1
         */
        public static GColor decode(String nm) throws NumberFormatException {
         ...
         * @since    JDK1.0
         */
        public static GColor getColor(String nm) {
         ...
         * @since    JDK1.0
         */
        public static GColor getColor(String nm, GColor v) {
  ...
  * Converts the components of a color, as specified by the default RGB
       ...
       * @since   JDK1.0
       */
      public static GColor getHSBColor(float h, float s, float b) {
          return new GColor(HSBtoRGB(h, s, b));
      }
