  ...
  implements Cloneable
{
   ...
   */
  public static GRegion union (GRegion region, Rect rectangle)
  {
    if (rectangle.isEmpty())
   ...
   */
  public static GRegion intersect (GRegion region, Rect rectangle)
  {
    if (rectangle.isEmpty())
      return new GRegion();
    else
   ...
   * @return           Subtraction of the two specified regions.
   */
  public static GRegion subtract (GRegion region, Rect rectangle)
  {
    if (rectangle.isEmpty())
      return new GRegion (region);
    else 
   ...
   * @return           Result of operation.
   */
  public static GRegion xor (GRegion region, Rect rectangle)
  {
    if (rectangle.isEmpty())
      return new GRegion();
    else
