  ...
  implements GStyleListener
{
  ...
  GRegion getRegion()
  {
    ...
    // Add extent of all components
    if (components_ != null) {
      for (Iterator<GComponent> i = components_.iterator(); i.hasNext(); ) {
        GComponent component = i.next();
   ...
   * @param y1  Y coordinate of second end point.      
   */
  public void setGeometry (double x0, double y0,
                           double x1, double y1)
  {
  ...
  public void addComponent (GComponent component)
  {
    // Create if first time
    if (components_ == null)
      components_ = new ArrayList<GComponent>();
