...
public class GStyle
    ...
    public Object clone() {
        ...
        if (foregroundColor_ != null) {
            style.foregroundColor_ = new GColor(foregroundColor_.getRed(),
        ...
        if (backgroundColor_ != null) {
            style.backgroundColor_ = new GColor(backgroundColor_.getRed(),
     ...
     *
     * @param style Style to call with.
     */
    ...
    public void setForegroundColor(GColor foregroundColor) {
        if (foregroundColor == null) foregroundColor = GColor.black;
