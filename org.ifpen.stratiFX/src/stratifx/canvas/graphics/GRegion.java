 ...
 * but with different back-end implementation. Benchmarking proves it more
  ...
  implements Cloneable
{
   ...
   */
  public GRegion (GRect rectangle)
  {
    this();
    set (rectangle);
  }
  ...
  {
    this (new GRect (x, y, width, height));
  }
  ...
  private static void checkMemory (GRegion region, int nRectangles)
  {
   ...
   * @param region  Region to copy.
   */
  public void set (GRegion region)
  {
   ...
   */
  public void set (GRect rectangle)
  {
    rectangles_ = new int[INITIAL_SIZE];      
   ...
   */
  public boolean isIntersecting (GRegion region)
  {
    GRegion r = (GRegion) clone();
    r.intersect (region);
    return !r.isEmpty();
  }
   ...
   */
  public boolean isIntersecting (GRect rectangle)
  {
    GRegion region = new GRegion (rectangle);
   ...
   *                   false otherwise.
   */
  public boolean isInside (GRect rectangle)
  {
   ...
   *                   false otherwise.
   */
  public boolean isInsideOf (GRect rectangle)
  {
   ...
   */
  public GRect getExtent()
  {
    return new GRect (extent_);
  }
   ...
   */
  private void combine (GRegion region, int operationType)
  {
   ...
   */
  public void union (GRegion region) 
  {
   ...
   */
  public void union (GRect rectangle)
  {
    if (rectangle.isEmpty())
      return;
    
    union (new GRegion (rectangle));
  }
   ...
   */
  public static GRegion union (GRegion r1, GRegion r2)
  {
    GRegion region = new GRegion (r1);
    region.union (r2);
    return region;
  }
   ...
   */
  public static GRegion union (GRegion region, GRect rectangle)
  {
    if (rectangle.isEmpty())
      return new GRegion (region);
    else
      return union (region, new GRegion (rectangle));
  }
   ...
   */
  public void intersect (GRegion region)
  {
   ...
   * @param region  Region to intersect this with.
   */
  public void intersect (GRect rectangle)
  {
    if (rectangle.isEmpty())
      clear();
    else
      intersect (new GRegion (rectangle));
  }
   ...
   */
  public static GRegion intersect (GRegion r1, GRegion r2)
  {
    GRegion region = new GRegion (r1);
    region.intersect (r2);
    return region;
   ...
   */
  public static GRegion intersect (GRegion region, GRect rectangle)
  {
    if (rectangle.isEmpty())
      return new GRegion();
    else
      return intersect (region, new GRegion (rectangle));
  }
   ...
   */
  public void subtract (GRegion region)
  {
   ...
   */
  public void subtract (GRect rectangle)
  {
    if (rectangle.isEmpty())
      return;

    subtract (new GRegion (rectangle));
  }
   ...
   */
  public static GRegion subtract (GRegion r1, GRegion r2)
  {
    GRegion region = new GRegion (r1);
    region.subtract (r2);
    return region;
   ...
   * @return           Subtraction of the two specified regions.
   */
  public static GRegion subtract (GRegion region, GRect rectangle)
  {
    if (rectangle.isEmpty())
      return new GRegion (region);
    else 
      return subtract (region, new GRegion (rectangle));
  }
   ...
   */
  public void xor (GRegion region)
  {
    GRegion r = (GRegion) region.clone();
    r.subtract (this);
    subtract (region);
    union (r);
  }
   ...
   */
  public void xor (GRect rectangle)
  {
    if (rectangle.isEmpty())
      clear();
    else
      xor (new GRegion (rectangle));
  }
   ...
   */
  public static GRegion xor (GRegion r1, GRegion r2)
  {
    GRegion region = new GRegion (r1);
    region.xor (r2);
    return region;
   ...
   * @return           Result of operation.
   */
  public static GRegion xor (GRegion region, GRect rectangle)
  {
    if (rectangle.isEmpty())
      return new GRegion();
    else
      return xor (region, new GRegion (rectangle));
  }
